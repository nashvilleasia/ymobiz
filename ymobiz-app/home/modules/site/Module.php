...
class Module extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'home\modules\site\controllers';
    ...
    public function registerTranslations()
    {
        \Yii::$app->i18n->translations['modules/site/*'] = [
            ...
            'fileMap' => [
                'modules/site/app' => 'app.php',
                'modules/site/error' => 'error.php',
    ...
    protected function getModuleComponents()
    {
        return [
            ...
            'ymoCardMenu' => [
                'class' => 'ymocardapp\common\components\ymoCardMenu'
            ],
