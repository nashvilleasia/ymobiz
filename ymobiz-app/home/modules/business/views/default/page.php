<?php
use ymobiz\components\ymoTranslate;
?>
<a href="#content" class="sr-only"><?php echo Yii::$app->getModule('business')->ymoTranslate->t('business','app','yii','app','Skip to main content  ') ?></a>
