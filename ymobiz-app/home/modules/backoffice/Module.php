...
namespace home\modules\backoffice;

use yii\filters\AccessControl;

class Module extends \yii\base\Module
{
    public $controllerNamespace = 'home\modules\backoffice\controllers';
    ...
    {
        \Yii::$app->i18n->translations['modules/backoffice/*'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'basePath' => '@app/modules/backoffice/messages',
            'fileMap' => [
                'modules/backoffice/app' => 'app.php',
                'modules/backoffice/error' => 'error.php',
                'modules/backoffice/common' => 'common.php',
                'modules/backoffice/form' => 'form.php',
            ],
        ];
    }
