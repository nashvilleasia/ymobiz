    ...
    <div class="col-md-12 ymo-header ymo-nopadding">
        <div class="col-md-3 ymo-logo ymo-nopadding">
            <a href="<?php echo \Yii::$app->urlManager->createAbsoluteUrl('') ?>">
                <img src="<?php echo \Yii::$app->getModule('business')->ymoTools->imageSrc('logo.png','img')?>" alt="..." class="img-responsive">
            </a>
        </div>
        ...
        if(!Yii::$app->user->isGuest)
        {
            ...
            <div class="col-md-9 ymo-menu-group ymo-nopadding">
                ...
                <ul class="col-md-11 ymo-menu list-inline ymo-nopadding">
                    <?php
                    echo $this->render('pages/menu-backoffice');
                    ?>
                </ul>
                <!--ymo-menu-->
            </div>
