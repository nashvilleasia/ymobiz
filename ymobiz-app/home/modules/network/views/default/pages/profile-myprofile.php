    ...
    <ul class="col-md-12 ymo-post ymo-nopadding ymo-Panel">
        <li>
            ...
            <div class="col-md-12 ymo-post-title ymo-nopadding">
                <h4 class="col-md-12 ymo-nopadding"><?php echo Yii::$app->getModule('network')->ymoTranslate->t('network','app','who are we?') ?></h4>
            </div>
            <!--ymo-post-title-->
        ...
        <li>
            <!--ymo-post-title-->
            <div class="col-md-12 ymo-post-title ymo-nopadding">
                <h4 class="col-md-12 ymo-nopadding"><?php echo Yii::$app->getModule('network')->ymoTranslate->t('network','app','brief description') ?></h4>
            </div>
            <!--ymo-post-title-->
        ...
        <li>
            ...
            <!--ymo-post-video-->
            <div class="col-md-12 ymo-post-video ymo-nopadding">
                <a href="<?php echo \Yii::$app->urlManager->createUrl('network/popups/album')?>">
        ...
        <li>
            <!--ymo-post-title-->
            <div class="col-md-12 ymo-post-title ymo-nopadding">
                <h4 class="col-md-12 ymo-nopadding"><?php echo Yii::$app->getModule('network')->ymoTranslate->t('network','app','our team') ?></h4>
            </div>
            <!--ymo-post-title-->
