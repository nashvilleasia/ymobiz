...
namespace home\modules\marketing;

use yii\filters\AccessControl;
class Module extends \yii\base\Module
{
    public $controllerNamespace = 'home\modules\marketing\controllers';
    ...
    {
        \Yii::$app->i18n->translations['modules/marketing/*'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'basePath' => '@app/modules/marketing/messages',
            'fileMap' => [
                'modules/marketing/app' => 'app.php',
                'modules/marketing/error' => 'error.php',
                'modules/marketing/common' => 'common.php',
                'modules/marketing/form' => 'form.php',
            ],
        ];
    }
