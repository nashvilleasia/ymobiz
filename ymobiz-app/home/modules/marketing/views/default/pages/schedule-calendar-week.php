<div class="col-xs-12 ymo-interface ymo-nopadding">
	...
	<!--ymo-column-left-->
		<?php echo \Yii::$app->view->render('schedule-sidebar-day') ?>
	<!--ymo-column-left-->
			...
			<div class="col-xs-12 ymo-menu-left ymo-nopadding">
				<ul class="list-inline ymo-nav-left">
					<li class="active">
                 	...
                 	<li> 
                     	13th - 19th <?php echo Yii::$app->getModule('marketing')->ymoTranslate->t('marketing','app','january') ?> 2013
                 	</li> 
                    <li>
                    	<a href="#">
			...
			<div class="col-xs-12 ymo-aside-general ymo-scroll ymo-nopadding">
				<div class="col-xs-12 ymo-aside ymo-nopadding">
					...
					<div class="ymo-calendar-image">
                    	<img src="<?php echo \Yii::$app->getModule('marketing')->ymoTools->imageSrc('calendar-week.png','img')?>" alt="...">
                	</div>
