...
/**
 * This is the model class for table "ymo_clients_driverslicence".
 *
 * @property integer $id
 ...
 */
class ymoClientsDriverslicence extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'ymo_clients_driverslicence';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['clients_id', 'countries_id', 'dateissue', 'dateexpiration'], 'integer'],
            [['code'], 'string', 'max' => 255]
        ];
    }
