...
class ymoPartnerNewCardHolderForm extends ActiveRecord
{
    ...
    public function attributes()
    {
        return array_merge(parent::attributes(), [
            'shipping_firstname','shipping_lastname','shipping_address','shipping_city','shipping_zipcode','shipping_state','shipping_country','shipping_choice',
    ...
    */
    ...
    {
        return [
        	'shipping_choice' => Yii::t('app','click here if your shipping address is diferent from the one above'),
    ...
    public function scenarios()
    {
        return [
        	'NewCardHolder' => [
        		'card_title','card_name','dateissue', 'dateexpiration','cardpin','name',
        	],
        	'ShippingCardHolder' => [
        		'shipping_firstname','shipping_choice','shipping_lastname','shipping_address',
    ...
    public function saveCard()
    {
    	...
    	$saveCard->client_id = Yii::$app->request->post('userid');
    ...
    public function saveShipping()
    {
    	...
    	if(@$model->shipping_choice){
	   		$saveShipping = new ymoClientsAddresses;
	    	 
	    	$saveShipping->client_id = Yii::$app->request->post('userid');
    ...
    {	
    	...
    	$cardID = Yii::$app->db->createCommand('SELECT id FROM ymo_cards WHERE client_id="'.Yii::$app->request->post('userid').'" ORDER BY id DESC LIMIT 1')->queryScalar();
