 ...
 */
class ymoPartnerSellerClientsForm extends \yii\db\ActiveRecord
{
	/*Params to form*/
   ...
   /*Attributes for company*/
    ...
    public function rules()
    {
        return [
        	...
        	[['countries_id'], 'common\validators\CountryPhoneCodeValidator', 'model' => '\common\models\forms\ymoPartnerSellerClientsForm', 'fieldsReplace' => ['mobile_prefix','phone_prefix'], 'on' => ['OrderSignup']],
            ...
            ['verifyCode', '\ymobiz\components\ymoCaptchaValidator', 'captchaAction' => 'partner-seller/default/captcha' ,'on' => ['OrderSignup']],
