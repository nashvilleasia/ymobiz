 ...
 */
class ymoClients extends \yii\db\ActiveRecord
{
	/*Params to form*/
   ...
   /*Attributes for company*/
    ...
    public function rules()
    {
        return [
        	...
        	[['countries_id'], 'common\validators\CountryPhoneCodeValidator', 'model' => '\common\models\ymoClients', 'fieldsReplace' => ['mobile_prefix','phone_prefix'], 'on' => ['OrderSignup']],
            ...
            ['verifyCode', '\ymobiz\components\ymoCaptchaValidator', 'captchaAction' => 'site/default/captcha' ,'on' => ['OrderSignup']],
