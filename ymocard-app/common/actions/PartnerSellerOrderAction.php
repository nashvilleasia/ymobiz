...
use common\models\forms\ymoPartnerSellerClientsForm;

class PartnerSellerOrderAction extends BaseAction
{
    public function OrderCreate()
    {
        $model = new ymoPartnerSellerClientsForm();
        ...
        if(Yii::$app->request->isAjax){
            ...
            if($step=='OrderSignup'){
            	...
            	if(!$model->validate($validate)) {
	                ...
	                return [
	                    'status' => 200,
	                    'redirect' => '/partner-seller/order-signup?step=OrderCard',
	                ];
                ...
                return [
                    'status' => 200,
                    'redirect' => '/partner-seller/order-signup?step=OrderPayment',
                ];
            	...
            	if(!$model->validate($validate)) {
	                ...
	                return [
	                    'status' => 200,
	                    'redirect' => '/partner-seller/order-signup?step=OrderFinish',
	                ];
            	...
            	if(is_array($register)) {
            		...
            		return [
            			'status' => 200,
            			'message' => 'Successful.',	
	            		'content' =>  Yii::$app->controller->render('@partner-seller-popups/registration-success'),
            		];
