        ...
        if(Yii::$app->request->isAjax){
            ...
            if($step=='OrderSignup'){
            	...
            	if(!$model->validate($validate)) {
	                ...
	                return [
	                    'status' => 200,
	                    'redirect' => '/site/order-signup?step=OrderCard',
	                ];
                ...
                return [
                    'status' => 200,
                    'redirect' => '/site/order-signup?step=OrderPayment',
                ];
            	...
            	if(!$model->validate($validate)) {
	                ...
	                return [
	                    'status' => 200,
	                    'redirect' => '/site/order-signup?step=OrderFinish',
	                ];
            	...
            	if(is_array($register)) {
            		...
            		return [
            			'status' => 200,
            			'message' => 'Successful.',	
	            		'content' =>  Yii::$app->controller->render('@site-popups/registration-success'),
            		];
