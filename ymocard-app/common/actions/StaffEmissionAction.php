...
class StaffEmissionAction extends BaseAction
{
    /**
     * @inheritdoc
     */
                ...
                if($model->saveMessagesSupervisor())
                {
                    ...
                    return [
                        ...
                        'content' =>  Yii::$app->controller->render('@common/errors/popup',[
							'custom' => Yii::$app->controller->renderPartial('@staff-emission-popups/send-message'),
            ...
            if ($model->load(Yii::$app->request->post())) {
                ...
                if($model->saveEmissionSupervisor())
                {
                    ...
                    return [
                        ...
                        'message' => 'Successfull.',
                        'content' =>  Yii::$app->controller->render('@common/errors/popup',[
							'custom' => Yii::$app->controller->renderPartial('@staff-emission-popups/emission-done'),
			            	'customJs' => new JsExpression("
			            		var ButtonSuccess = jQuery(document);
								ButtonSuccess.on('click','.close-modal',function(){
									location.reload();
