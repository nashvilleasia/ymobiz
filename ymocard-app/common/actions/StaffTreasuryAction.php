...
class StaffTreasuryAction extends BaseAction
{
    /**
     * @inheritdoc
     */
                ...
                if($model->saveMessagesSupervisor())
                {
                    ...
                    return [
                        ...
                        'content' =>  Yii::$app->controller->render('@common/errors/popup',[
							'custom' => Yii::$app->controller->renderPartial('@staff-treasury-popups/send-message'),
            ...
            if ($model->load(Yii::$app->request->post())) {
                ...
                if($model->saveTreasurySupervisor())
                {
                    ...
                    return [
                        ...
                        'message' => 'Successfull.',
                        'content' =>  Yii::$app->controller->render('@common/errors/popup',[
							'custom' => Yii::$app->controller->renderPartial('@staff-treasury-popups/payment-confirmed'),
			            	'customJs' => new JsExpression("
			            		var ButtonSuccess = jQuery(document);
								ButtonSuccess.on('click','.close-modal',function(){
									location.reload();
