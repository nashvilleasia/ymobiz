        ...
        <table id="Table_01" width="759" height="345" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="2" style="width: 510px; height: 192px; background: #ffffff; line-height: 0px;">
                    <h4 style="float left; font-size: 1.50em; font-family: 'Trebuchet MS'; color: #787878; padding-right: 40px; margin: 5px 0px 0px 60px;">
                    ...
                    <p style="float left; font-size: 1.25em; font-family: 'Trebuchet MS'; color: #787878; padding-right: 40px; margin: 10px 0px 0px 60px; line-height: 20px;">
                    ...
                    <h6 style="float left; padding-right: 40px; margin: 21px 0px 0px 60px;">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <p style="float left; font-size: 1.25em; font-family: 'Trebuchet MS'; color: #787878;">
                                        <strong style="font-family: 'Trebuchet MS'; margin-right: 6px;"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','email:')?> </strong>
                            ...
                            <tr>
                                <td>
                                    <p style="float left; font-size: 1.25em; font-family: 'Trebuchet MS'; color: #787878;">
                                        <strong style="font-family: 'Trebuchet MS'; margin-right: 6px;"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','password:')?></strong>
                                        123456789
                                    </p>
                                </td>
                            </tr>
    ...
    <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <table id="Table_01" width="759" height="345" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td rowspan="2" style="width: 237px; height: 70px; line-height: 0px;">
                    <img src="http://ww2.ymocard.ymobiz.ws//home/web/themes/basic/img/images/logo.jpg" alt="">
                </td>
                <td colspan="2" style="width: 522px; height: 41px; background: #ffffff; line-height: 0px;">
                </td>
            </tr>
            <tr>
                ...
                <td rowspan="2" style="width: 249px; height: 221px; line-height: 0px; position: relative; background-color: #ffffff;">
                	<img style="vertical-align: bottom; position: absolute; bottom: 0px;" src="http://ww2.ymocard.ymobiz.ws//home/web/themes/basic/img/images/girl.jpg" alt="" />
                </td>
            </tr>
            <tr>
                <td colspan="2" style="width: 510px; height: 100%;  background: #ffffff; padding: 0px 30px 0px 30px;">
                    <?php echo $template ?>
                </td>
            </tr>
            <tr>
                <td colspan="3" style="width: 759px; height: 83px; line-height: 0px;">
                    <img src="http://ww2.ymocard.ymobiz.ws//home/web/themes/basic/img/images/footer.jpg" alt="">
                </td>
            </tr>
        </table>
    </body>
