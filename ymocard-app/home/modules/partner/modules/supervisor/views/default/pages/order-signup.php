...
$form = \mcms\ajaxform\AjaxActiveFormOne::begin([
    'id' => 'OrderSignup',
    'action' => '/partner-supervisor/order-signup?step=OrderSignup',
    'options' => [
...
<h2 class="ymo-title-b" style="float: left; margin-right: 20px;;">
    <?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','form','Personal Details') ?>
</h2>
<p class="ymo-required" style="padding-top: 11px;">
