...
echo ymoTools::preloadModal([
	['id'=>'more-documents','module' => 'partner/modules/supervisor'],
]);
            ...
            <div class="col-md-11 col-md-offset-1 ymo-management ymo-nopadding ymo-Panel">
                       ...
                       <?php
	                        ...
	                        echo \mcms\ajaxform\EditableActiveForm::widget([
	                            ...
	                            'activeForm' => [
	                                ...
	                                'options' => [
	                                    'action' => '/partner-supervisor/edit-account-supervisor?memberid='.ymoMemberForm::findMemberId(),
	                                ]
	                            ]
	                        ]);
				...
				<?php
					if($viewMembers!=false){
						...
						$userModel = ymoUser::findOne($viewMembers->id);
						$staffModel = new ymoPartnerMemberForm;
                ...
                <!--Start documents-->
                        ...
                        echo \mcms\ajaxform\EditableActiveForm::widget([
                            ...
                            'activeForm' => [
	                            'class' => 'mcms\ajaxform\AjaxActiveFormOne',
	                           	'activeFieldClass' => 'kartik\widgets\ActiveField',                                
                                'options' => [
                                    'action' => '/partner-supervisor/edit-documents-members?memberid='.ymoMemberForm::findMemberId(),
                                ]
                            ],
                        	'pluginOptions' => [
                            	'data' => [
                    ...
                    <?php if(ymoClientsFiles::findOne(['clients_id'=>ymoClients::findOne(['user_id'=>ymoPartnerMemberForm::checkMemberId()])->id])!=false){?>
                ...
                <?php 
                	...
                	$form = \mcms\ajaxform\AjaxActiveFormOne::begin([
					    'id' => 'editMember',
					    'action' => '/partner-supervisor/edit-member', 
                		'options' => [
