...
$view->registerJs("
	...
	jQuery(document).on('change','.filter-card', function(e){
		...
		if(this.value!==''){
			...
			window.location = '/partner-seller/order-payment/filter/' + decodeURI(filterValue);
		}
	});	
    ...
    <div class="col-md-11 col-md-offset-1 ymo-card-list ymo-nopadding ymo-Panel">
        ...
        <div class="col-md-4 ymo-nopadding">
        	<?php if(Yii::$app->requestedAction->id!='order-payment'){?>
       	 	...
       	 	<?php }else{?>
       	 		<a href="<?php echo \Yii::$app->urlManager->createUrl('partner-seller/order-signup')?>" class="col-md-12 btn ymo-btn-light-pink" style="margin-bottom: 3px;"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','order new ymocard')?></a>
       	 	<?php }?>
    ...
    <div class="col-md-11 col-md-offset-1 ymo-search ymo-nopadding ymo-Panel">
        ...
        <div class="col-md-5 col-md-offset-2 ymo-nopadding ymo-Panel">
            ...
            $form = \yii\bootstrap\ActiveForm::begin([
                'action' => '/partner-seller/order-payment',
                'method' => 'post',
            ])
            ?>
