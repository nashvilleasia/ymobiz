...
$view->registerJs("
	var unblockButtonSuccess = jQuery(document);
	unblockButtonSuccess.on('click','button.reload-block-success',function(){
		location.reload();
	});
");

Modal::begin([
    'id' => 'unblock-ymocard-success',
    'clientOptions' => [
        'show' => true,
     	'backdrop' => 'static',
     	'keyboard' => false,	
...
<div class="popup-dialog ">
    <div class="bs-modal-sm ymo-popup">
        <div class="popup-header">
            <h4 class="modal-title" id="unblock-ymocard-success"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','done')?></h4>
        </div>
        <div class="modal-body popup-body">
		    <div class="row">
			    <div class="col-md-12 popup-text">
                    <?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','ymocard successfully unblocked.')?>
                </div>
		    </div>
        </div>
