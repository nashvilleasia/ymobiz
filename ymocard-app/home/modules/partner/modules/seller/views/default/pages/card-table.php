...
$view->registerJs("
	...
	jQuery(document).on('change','.filter-card', function(e){
		...
		if(this.value!==''){
			...
			window.location = '/partner-seller/registered-cards/filter/' + decodeURI(filterValue);
		}
	});	
...
<div class="col-md-6 ymo-column-left ymo-nopadding ymo-Panel">
    ...
    <div class="col-md-11 col-md-offset-1 ymo-card-list ymo-nopadding ymo-Panel">
        ...
        <div class="col-md-4 ymo-nopadding">
       		<a href="<?php echo \Yii::$app->urlManager->createUrl('partner-seller/order-payment')?>" class="col-md-12 btn ymo-btn-light-pink" style="margin-bottom: 3px;"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','ymocards payment')?></a>
       	 	<?php if(Yii::$app->requestedAction->id=='order-card' || Yii::$app->requestedAction->id=='order-signup'){?>
       	 		<a href="<?php echo \Yii::$app->urlManager->createUrl('partner-seller/registered-cards')?>" class="col-md-12 btn ymo-btn-light-pink"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','registered-cards')?></a>
       	 	<?php }else{?>
       	 		<a href="<?php echo \Yii::$app->urlManager->createUrl('partner-seller/order-signup')?>" class="col-md-12 btn ymo-btn-light-pink"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','order new ymocard')?></a>
       	 	<?php }?>
    ...
    <div class="col-md-11 col-md-offset-1 ymo-search ymo-nopadding ymo-Panel">
        ...
        <div class="col-md-5 col-md-offset-2 ymo-nopadding ymo-Panel">
            ...
            $form = \yii\bootstrap\ActiveForm::begin([
                'action' => '/partner-seller/registered-cards',
                'method' => 'post',
            ])
            ?>
