            ...
            <!--form-->
                <?php
					...
					$form = \mcms\ajaxform\AjaxActiveFormOne::begin([
					    'id' => 'orderCard',
					    'action' => '/partner-seller/order-signup?step=OrderCard',
					    'options' => [
				...
				?>
                    ...
                    <div class="col-md-12 ymo-card-form ymo-nopadding ymo-Panel">
                        ...
                        <div class="col-md-12 ymo-nopadding ymo-Panel">
                            ...
                            <?php
                            echo \yii\helpers\Html::a(Yii::$app->getModule('site')->ymoTranslate->t('site','form','Back'),'/partner-seller/order-signup?step=OrderSignup',[
