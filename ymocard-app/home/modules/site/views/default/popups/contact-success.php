...
<div class="popup-dialog">
    <div class="bs-modal-sm ymo-popup">
        <div class="popup-header">
            <h4 class="modal-title" id="contact-sucess"><?=Yii::$app->getModule('site')->ymoTranslate->t('site','popups','done')?></h4>
        </div>
        <div class="modal-body popup-body">
		    <div class="row">
			    <div class="col-md-12 popup-text">
				    <?=Yii::$app->getModule('site')->ymoTranslate->t('site','popups','thank you for your contact')?>
			    </div>
		    </div>
        </div>
