...
<div class="popup-dialog ">
    <div class="bs-modal-sm ymo-popup">
        <div class="popup-header">
            <h4 class="modal-title" id="myModalLabel"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','proof os residence, required')?></h4>
        </div>
        <div class="modal-body popup-body">
		    <div class="row">
			    <div class="col-md-12 popup-text">
                    <?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','please,
                        to proceed, upload a new proof of residence.
                        its a compliance necessary requirement.
                        ')?>
			    </div>
		    </div>
        </div>
