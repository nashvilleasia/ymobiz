...
namespace home\modules\staff\modules\compliance\controllers;
...
class DefaultController extends Controller
{
    ...
    public function init()
    {
        ...
        \Yii::$app->assetManager->bundles = Yii::$app->getModule('staff-compliance')->components['assetManager']['bundles'];
    }
    ...
    public function actions()
    {
        return [
            ...
            'send-message' => [
                'class' => 'common\actions\StaffComplianceAction',
                'options' => [
                    'action' => 'sendMessages',
                ],
            ],
