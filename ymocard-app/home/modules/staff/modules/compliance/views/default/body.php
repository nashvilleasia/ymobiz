                        ...
                        <ul class="ymo-Panel">
                            ...
                            <li>
                                <strong><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','state: ')?></strong>
                                 <?=(is_numeric($cards->clientsOne->state)) ? ymoStates::findOne($cards->clientsOne->state)->name 
                                 : $cards->clientsOne->state?>
                            </li>
                            <li>
                             ...
                             <?php 
		                    	...
		                    	if($listFiles){
		                    		...
		                    		echo ymoTools::preloadModal([
		                    			['id'=>'more-documents','module' => 'staff/modules/compliance','params'=>['clientid'=>$cards->clientsOne->user_id]],
		                    		]);
				...
				<?php 
                    	if(ymoCardsCompliance::checkCompliance($cards->id)!=false){
                    		...
                    		$form = \mcms\ajaxform\AjaxActiveFormOne::begin([
                    			'id' => 'SaveCompliance',
                    			'action' => '/staff-compliance/save-compliance',
