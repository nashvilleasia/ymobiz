...
echo ymoTools::preloadModal([
	['id'=>'more-comments','size'=>'lg', 'module' => 'staff/modules/compliance','params'=> ['cardid'=>$viewCards->one()->id,'moduleid'=>Yii::$app->controller->action->id]],
]);
    ...
    <!--form-->
     <?php 
                	...
                	$form = \mcms\ajaxform\AjaxActiveFormOne::begin([
					    ...
					    'action' => '/staff-compliance/send-message', 
                		'options' => [
