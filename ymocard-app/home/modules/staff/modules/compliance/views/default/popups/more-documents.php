        ...
        <div class="modal-body popup-body">
		    <div class="row">
			    <div class="col-md-12 ymo-card-documents" style="margin-top: 0px; height: 200px; overflow: auto;">
                    ...
                    <?php 
                    	$documents = new ymoMemberForm();
                    	
                    	if(method_exists($documents->documents, 'one')){
                    		echo $documents->documents->one()->getListUploadDocs(false,(@$clientid) ? $clientid : ymoClients::findOne(['user_id'=>ymoMemberForm::findMemberId()])->user_id);
                    	}else{
                    		echo $documents->documents->getListUploadDocs(false,(@$clientid) ? $clientid : @ymoClients::findOne(['user_id'=>ymoMemberForm::findMemberId()])->user_id);
                    	}
                    ?>
                    </ul>
                </div>
