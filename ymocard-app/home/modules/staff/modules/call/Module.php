...
namespace home\modules\staff\modules\call;
...
class Module extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'home\modules\staff\modules\call\controllers';
    ...
    {
        \Yii::$app->i18n->translations['modules/staff/modules/call/*'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'basePath' => '@app/modules/staff/modules/call/messages',
            'fileMap' => [
                'modules/staff/modules/call/common' => 'common.php',
                'modules/staff/modules/call/form' => 'form.php',
            ],
        ];
    }
