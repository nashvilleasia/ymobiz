                    ...
                    <div class="col-md-12 ymo-card-details ymo-nopadding ymo-Panel">
                        ...
                        <ul class="ymo-Panel">
                            ...
                            <li>
                                ...
                                <?=($cards->ordersOne->created_at) ? date("jS F Y",$cards->ordersOne->created_at) : false?>
                            </li>
                            <li>
                             ...
                             <?php 
		                    	...
		                    	if($listFiles){
		                    		...
		                    		echo ymoTools::preloadModal([
		                    			['id'=>'more-documents','size'=>'sm', 'module' => 'staff/modules/call','params'=>['clientid'=>$cards->clientsOne->user_id]],
		                    		]);
