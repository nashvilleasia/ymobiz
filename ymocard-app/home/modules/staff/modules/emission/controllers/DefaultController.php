...
namespace home\modules\staff\modules\emission\controllers;
...
class DefaultController extends Controller
{
    ...
    public function init()
    {
        ...
        \Yii::$app->assetManager->bundles = Yii::$app->getModule('staff-emission')->components['assetManager']['bundles'];
    }
    ...
    public function actions()
    {
        return [
            ...
            'view-file' => [
                'class' => 'common\actions\StaffEmissionAction',
                'options' => [
                    'action' => 'viewFile',
                ],
            ],
