...
<div class="col-md-6 ymo-column-left ymo-nopadding ymo-Panel">
    ...
    <div class="col-md-11 col-md-offset-1 ymo-card-table ymo-nopadding">
         ...
         if(Yii::$app->request->get('filter')==false){
         	$models = (Yii::$app->request->post('search') || Yii::$app->request->get('search')) ? $model->searchEmissionCards('default/order-emission') : $model->listEmissionCards();
         }else{
         	$models = (Yii::$app->request->get('filter')) ? $model->filterEmissionCards('/staff-emission/order-emission') : false;
         }
            ...
            'columns' => [
                ...
                [
                    ...
                    'buttons' => ['view-card' => function ($url, $model) {
                            ...
                            return "<a $status href='".\yii\helpers\Url::toRoute(['default/order-emission','cardid' => $model->id,'search' => Yii::$app->request->get('search'), 'filter' => Yii::$app->request->get('filter'),  'page' => Yii::$app->request->get('page')])."' data-pjax=0>".Yii::$app->getModule('site')->ymoTranslate->t('site','app',($status) ? 'order emission' : 'order emission sent')."</a>";
    ...
    <div class="col-md-11 col-md-offset-1 ymo-search ymo-nopadding ymo-Panel">
        ...
        <div class="col-md-5 col-md-offset-2 ymo-nopadding ymo-Panel">
            ...
            $form = \yii\bootstrap\ActiveForm::begin([
                'action' => '/staff-emission/order-emission',
                'method' => 'post',
            ])
            ?>
