...
echo ymoTools::preloadModal([
	['id'=>'more-comments','size'=>'lg', 'module' => 'staff/modules/treasury','params'=> ['cardid'=>$viewCards->one()->id,'moduleid'=>Yii::$app->controller->action->id]],
]);
    ...
    <!--form-->
     <?php 
                	...
                	$form = \mcms\ajaxform\AjaxActiveFormOne::begin([
					    ...
					    'action' => '/staff-treasury/send-message', 
                		'options' => [
