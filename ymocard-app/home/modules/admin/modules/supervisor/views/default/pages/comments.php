...
echo ymoTools::preloadModal([
	['id'=>'more-comments','size'=>'lg', 'module' => 'admin/modules/supervisor','params'=> ['cardid'=>$viewCards->one()->id,'moduleid'=>Yii::$app->controller->action->id]],
]);
    ...
    <!--form-->
     <?php 
                	...
                	$form = \mcms\ajaxform\AjaxActiveFormOne::begin([
					    ...
					    'action' => '/supervisor/send-message', 
                		'options' => [
