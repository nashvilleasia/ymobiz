...
$memberID = (ymoMemberForm::checkMemberId()) ? ymoMemberForm::checkMemberId() : 'null';
...
$view->registerJs("
	...
	jQuery(document).on('change','.filter-member', function(e){
		...
		if(this.value!==''){
			...
			window.location = '/supervisor/members/filter/' + decodeURI(filterValue);
		}
	});
...
<div class="col-md-6 ymo-column-left ymo-nopadding ymo-Panel">
    ...
    <div class="col-md-11 col-md-offset-1 ymo-members ymo-nopadding ymo-Panel">
        ...
        <div class="col-md-3 ymo-nopadding">
       	 	<a href="<?php echo \Yii::$app->urlManager->createUrl('/supervisor/add-members')?>" class="col-md-12 btn ymo-btn-light-pink" style="margin-bottom: 5px;"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','add staff member')?></a>
        	<a href="<?php echo \Yii::$app->urlManager->createUrl('/supervisor/members')?>" class="col-md-12 btn ymo-btn-light-pink"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','refresh')?></a>
        </div>
    </div>
    <!-- End ymo-card-list-->
