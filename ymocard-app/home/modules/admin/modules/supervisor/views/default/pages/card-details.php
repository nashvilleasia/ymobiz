                        ...
                        <ul class="ymo-Panel">
                            ...
                            <li>
                                <strong><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','date of birth: ')?></strong>
                                 <?=date("jS F Y",$cards->getClientsById($cards->clientsOne->user_id,'dob'))?>
                            </li>
                            <li>
                            ...
                            <li>
                                <strong><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','country of birth: ')?></strong>
                                 <?=ymoCountries::findOne($cards->getClientsById($cards->clientsOne->user_id,'countryob_id'))->name?>
                            </li>
                            <li>
                                <strong><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','country of nationality: ')?></strong>
                                 <?=ymoCountries::findOne($cards->getClientsById($cards->clientsOne->user_id,'countrynat_id'))->name?>
                            </li>
                        </ul>
                    </div>
                    <!--ymo-card-details-->
                        ...
                        <ul class="ymo-Panel">
                            ...
                            <li>
                                <strong><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','country: ')?></strong>
                                 <?=ymoCountries::findOne($cards->clientsOne->countries_id)->name?>
                            </li>
                        </ul>
                    </div>
                    <!--ymo-card-details-->
                             ...
                             <?php 
		                    	...
		                    	if($listFiles){
		                    		...
		                    		echo ymoTools::preloadModal([
		                    			['id'=>'more-documents','size'=>'md', 'module' => 'admin/modules/supervisor','params'=>['clientid'=>$cards->clientsOne->user_id]],
		                    		]);
