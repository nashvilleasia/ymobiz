    ...
    <div class="col-md-11 col-md-offset-1 ymo-card-table ymo-nopadding">
        <table class="table table-responsive ymo-table">
            ...
            <tr class="ymo-item">
                ...
                <td class="text-right"><a href="<?php echo \Yii::$app->urlManager->createUrl('admin-superuser/emission')?>"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','check payment') ?></a></td>
            </tr>
            <tr class="ymo-item">
                <td>123...987 | Mr. Pedro Almeida | <?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','Pendent') ?></td>
                <td class="text-right"><a href="#"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','check payment') ?></a></td>
            </tr>
            <tr class="ymo-item">
                <td>123...987 | Mr. Pedro Almeida | <?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','Pendent') ?></td>
                <td class="text-right"><a href="#"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','check payment') ?></a></td>
            ...
            <tr class="ymo-item">
                <td>123...987 | Mr. Pedro Almeida | <?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','Pendent') ?></td>
                <td class="text-right"><a href="#"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','check payment') ?>t</a></td>
            </tr>
            <tr class="ymo-item">
                <td>123...987 | Mr. Pedro Almeida | <?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','Pendent') ?></td>
                <td class="text-right"><a href="#"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','check payment') ?></a></td>
