...
<div class="col-md-6 ymo-column-left ymo-nopadding ymo-Panel">
    ...
    <div class="col-md-11 col-md-offset-1 ymo-card-table ymo-table ymo-nopadding">
        <table class="table table-responsive ymo-table">
            ...
            <tr class="ymo-item">
                ...
                <td class="text-right"><a href="<?php echo \Yii::$app->urlManager->createUrl('staff-call')?>"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','view details') ?></a></td>
            </tr>
            <tr class="ymo-item">
                <td>123...987 | Mr. Pedro Almeida | <?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','Pendent') ?></td>
