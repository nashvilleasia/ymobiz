...
<div class="col-md-6 ymo-column-left ymo-nopadding ymo-Panel">
    ...
    <div class="col-md-11 col-md-offset-1 ymo-members ymo-nopadding ymo-Panel">
        ...
        <a href="<?php echo \Yii::$app->urlManager->createUrl('partner-supervisor/add-members')?>" class="ymo-btn-light-pink"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','add staff member')?></a>
    </div>
    <!-- End ymo-card-list-->
    ...
    <div class="col-md-11 col-md-offset-1 ymo-card-table ymo-nopadding">
        <table class="table table-responsive ymo-table">
            <tbody>
            <tr class="ymo-item">
                <td>Mr. Pedro Almeida</td>
                <td class="text-right"><a href="<?php echo \Yii::$app->urlManager->createUrl('partner-supervisor/members-management')?>"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','view details')?></a></td>
            </tr>
            <tr class="ymo-item">
                <td>Mr. Pedro Almeida</td>
                <td class="text-right"><a href="#"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','view details')?></a></td>
            </tr>
            <tr class="ymo-item">
                <td>Mr. Pedro Almeida</td>
                <td class="text-right"><a href="#"><?php echo Yii::$app->getModule('site')->ymoTranslate->t('site','app','view details')?></a></td>
