...
namespace home\modules\admin\modules\superuser;
...
class Module extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'home\modules\admin\modules\superuser\controllers';
    ...
    {
        \Yii::$app->i18n->translations['modules/admin/modules/superuser*'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'basePath' => '@app/modules/admin/modules/superuser/messages',
            'fileMap' => [
                'modules/admin/modules/superuser/common' => 'common.php',
                'modules/admin/modules/superuser/form' => 'form.php',
            ],
        ];
    }
