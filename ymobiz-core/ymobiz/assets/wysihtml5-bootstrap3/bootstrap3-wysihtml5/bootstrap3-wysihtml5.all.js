...
window.rangy = function () {
	...
	function h(a) {
		...
		a: if (c.length && 1 == c[0].nodeType) {
			...
			b = !0
		} else b = !1; if (!b) throw Error("getSingleElementFromRange: range " + a.inspect() + " did not consist of a single element");
		return c[0]
	}
...
Base.extend = function (a, b) {
	...
	var c = {
		...
		f = {
			tags: {},
			classes: {}
		}, g = {}, h = !wysihtml5.browser.supportsGetAttributeCorrectly(),
		i = {
			url: function () {
				var a = /^https?:\/\//i;
				return function (b) {
...
this.wysihtml5 = this.wysihtml5 || {}, this.wysihtml5.tpl = this.wysihtml5.tpl || {}, this.wysihtml5.tpl.blockquote = Handlebars.template(function (a, b, c, d, e) {
	...
	var h, i, j = "",
		...
		l = this.escapeExpression,
		m = this;
	return j += '<li>\n  <div class="bootstrap-wysihtml5-insert-image-modal modal fade">\n    <div class="modal-dialog ', i = c["if"].call(b, (h = b && b.options, null == h || h === !1 ? h : h.smallmodals), {
		hash: {},
		inverse: m.noop,
		fn: m.program(1, f, e),
		data: e
		...
		fn: m.program(3, g, e),
		data: e
	}), (i || 0 === i) && (j += i), j += ' btn-default" data-wysihtml5-command="insertImage" title="' + l((h = b && b.locale, h = null == h || h === !1 ? h : h.image, h = null == h || h === !1 ? h : h.insert, typeof h === k ? h.apply(b) : h)) + '" tabindex="-1">\n    <span class="glyphicon glyphicon-picture"></span>\n  </a>\n</li>\n'
	...
	return j += '<li>\n  <div class="bootstrap-wysihtml5-insert-link-modal modal fade">\n    <div class="modal-dialog ', i = c["if"].call(b, (h = b && b.options, null == h || h === !1 ? h : h.smallmodals), {
		...
		fn: m.program(3, g, e),
		data: e
	}), (i || 0 === i) && (j += i), j += ' btn-default" data-wysihtml5-command="createLink" title="' + l((h = b && b.locale, h = null == h || h === !1 ? h : h.link, h = null == h || h === !1 ? h : h.insert, typeof h === k ? h.apply(b) : h)) + '" tabindex="-1">\n    <span class="glyphicon glyphicon-share"></span>\n  </a>\n</li>\n'
	...
	d.prototype = {
		...
		createEditor: function (c) {
			...
			if (this.addMoreShortcuts(d, d.currentView.iframe.contentDocument.body || d.currentView.iframe.contentDocument, c.shortcuts), c && c.events)
