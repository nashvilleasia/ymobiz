...
/* @var $searchModel ymobiz\models\ymoSearchLanguages */
...
<?php 
	...
	echo GridView::widget([
		...
		'panel' => [
			...
			'type'=>'primary',
			'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> '.Yii::t('app', 'Create Languages', [
    'modelClass' => 'Ymo Languages',
]), ['create'], ['class' => 'btn btn-success']),
			'after'=>Html::a('<i class="glyphicon glyphicon-repeat"></i> '.Yii::t('app', 'Reset Grid Languages', [
    'modelClass' => 'Ymo Languages',
