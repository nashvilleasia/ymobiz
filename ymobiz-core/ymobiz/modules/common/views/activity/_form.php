...
<div class="ymo-clients-activity-form">
...
<?php 	
    ...
    <?= $form->field($model, 'card_id')->dropDownList(ArrayHelper::map(ymoClients::find()->all(),'id','email')) ?>

    <?= $form->field($model, 'title')->textInput(['maxlength' => 255]) ?>

    <?= $form->field($model, 'message')->textarea(['rows' => 6])->widget(CKEditor::className(),['preset' => 'basic']) ?>
