...
/* @var $searchModel ymobiz\models\ymoSearchContents */
...
<?php 
	...
	echo GridView::widget([
		...
		'panel' => [
			...
			'type'=>'primary',
			'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> '.Yii::t('app', 'Create Contents', [
    'modelClass' => 'Ymo Contents',
]), ['create'], ['class' => 'btn btn-success']),
			'after'=>Html::a('<i class="glyphicon glyphicon-repeat"></i> '.Yii::t('app', 'Reset Grid Contents', [
    'modelClass' => 'Ymo Contents',
