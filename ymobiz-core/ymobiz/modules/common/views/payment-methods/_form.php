...
<div class="ymo-payment-methods-form">
...
<?php 	
    ...
    <?= $form->field($model, 'type')->dropDownList(ArrayHelper::map(ymobiz\models\common\ymoPaymentTypes::find()->all(),'id','name')) ?>
